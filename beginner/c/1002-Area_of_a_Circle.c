...
/*  ---------------------------------------------------------------------------------
    ...
    bellow, with four places after the decimal point. Use all double precision
    variables. Like all the problems, don't forget to print the end of line after the
